 ...
 *
 */
public class WorkLocationVO extends BaseVO {
  ...
  private WorkLocationAddressVO workLocationAddress;
  // ------------------------------------------------------------ Constructors

  /**
   * Create a new <code>WorkLocationVO</code>
   */
  public WorkLocationVO() {
    super();
  }
   ...
   */
  public WorkLocationAddressVO getWorkLocationAddress() {
   ...
   */
  public void setWorkLocationAddress(WorkLocationAddressVO workLocationAddress) {
